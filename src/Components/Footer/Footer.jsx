    ...
    return(
        <motion.footer layout>
            ...
            <div id='aboutUs'> 
                ...
                <p>Καλωσήρθατε στην ιστοσελίδα της εργασίας «Μια στραγόνα, μια ζωή» του Ομίλου Μετεωρολογίας - Αστρονομίας του 1ου Πειραματικού Γυμνασίου Λάρισας στα πλαίσα του προγράμματος <a href='https://climatedetectives.esa.int/'>Climate Detectives</a>. Θεσσαλία. Σε αυτή την εργασία αναλύουμε τις συνέπειές αυτού της κακοκαιρίας Daniel και συγκεντρώνουμε γενικότερες πληροφορίες σχετικά με αυτήν.</p>
            </div>
            <div>
